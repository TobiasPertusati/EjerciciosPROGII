...
namespace Clase20_09_EF.DLL.Data.Models;

public partial class clase_20_09DbContext : DbContext
{
    public clase_20_09DbContext(DbContextOptions<clase_20_09DbContext> options)
        : base(options)
    {
