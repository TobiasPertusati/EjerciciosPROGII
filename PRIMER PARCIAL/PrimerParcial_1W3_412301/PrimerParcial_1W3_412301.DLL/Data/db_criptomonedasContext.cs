...
namespace PrimerParcial_1W3_412301.DLL.Data.Models;

public partial class db_criptomonedasContext : DbContext
{
    public db_criptomonedasContext(DbContextOptions<db_criptomonedasContext> options)
        : base(options)
    {
    }
